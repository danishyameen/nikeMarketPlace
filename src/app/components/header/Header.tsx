            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Link href="/cart" className="p-2 relative">
                <Image
                  ...
                  height={32}
                />
                <span className="absolute top-5 left-3 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center transform translate-x-1/4 -translate-y-1/4">
                  {cartCount}
                </span>
              </Link>
            </motion.div>
